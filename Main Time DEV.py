...
def gameLoop():
    ...
    while not game_over:
        ...
        while game_close == True:
            dis.fill(black)
            message(f"GAME OVER! Your final score is {snake_len - 3}. Press 'Space'--play again or 'Esc'--quit", red)
        ...
        dis.blit(orangeImg, (x_orange, y_orange))
        ...
        if x_head == x_orange and y_head == y_orange:
            ...
            countdown+=random.randint(3, 5)*snake_speed
        # 吃到炸彈
